...
#held in memory/cookies only. not stored in database. needs to be handled different
delete "auths" => "auths#destroy"

#you can use this if there is only ONE off route not included in the array above. 
